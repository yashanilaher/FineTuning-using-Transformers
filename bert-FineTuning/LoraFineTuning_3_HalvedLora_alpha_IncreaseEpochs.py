...
# lora_alpha=16: Halves the scaling factor
# num_train_epochs=7: More epochs 
...
# Define paths
model_output_dir = "./lora_finetuned_bert_3"
...
training_args = TrainingArguments(
    output_dir="./lora_finetuned_bert_check_3",   # by mistakley its saved in 2
